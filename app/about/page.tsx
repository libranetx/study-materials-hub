...
export const metadata = {
  ...
  description:
    "Learn about StudyHub and our mission to provide quality learning materials",
};
  ...
  const values = [
    {
      title: "Accessibility",
      description:
        "Learning should be available to everyone, everywhere, regardless of background or circumstance.",
      icon: "🎓",
    },
    {
      title: "Quality",
      description:
        "We curate only the best materials from trusted educators and institutions worldwide.",
      icon: "⭐",
    },
    {
      title: "Community",
      description:
        "We build a supportive community where students and educators collaborate and grow together.",
      icon: "🤝",
    },
    {
      title: "Innovation",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <div className="card-item">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                To democratize access to high-quality educational materials and
                create a community where learning is seamless, enjoyable, and
            ...
            <div className="card-item">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                To become the world's most trusted platform for educational
                resources, empowering millions of learners to achieve their
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="service-card">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Carefully selected materials from trusted educators and
                  institutions.
                </p>
              </div>
              ...
              <div className="service-card">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Simple search, filtering, and instant downloads for all your
                  needs.
                </p>
              </div>
              ...
              <div className="service-card">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Free access to essential materials with premium options
                  available.
                </p>
              </div>
            </div>
          ...
          <div className="bg-linear-to-br from-blue-600 to-cyan-500 rounded-2xl p-12 text-center text-white">
            ...
            <p className="text-lg mb-8 opacity-95">
              Start exploring thousands of resources and join learners from
              around the world.
            </p>
